...
class ShelfSelector extends React.Component {
    ...
    render(){
        ...
        <div className="book-shelf-changer">
            <select onChange={(event) => this.onShelfMove(event)} value={this.props.picker ? '' : this.props.book.shelf}> 
            <option value="" disabled>{this.props.picker ? 'Pick and place on...' : 'Move to...'}</option>
